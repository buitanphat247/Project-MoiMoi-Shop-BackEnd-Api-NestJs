...
__decorate([
    (0, common_1.Get)(),
    (0, customize_1.ResponseMessage)('Get all roles'),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, customize_1.ResponseMessage)('Get a role by id'),
...
__decorate([
    (0, common_1.Put)(':id'),
    (0, customize_1.ResponseMessage)('Update a role by id'),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    (0, customize_1.ResponseMessage)('Delete a role by id'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, customize_1.User)()),
    __metadata("design:type", Function),
